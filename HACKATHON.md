...
- Problem statement: TripWallet — Smart Budget & Expense Companion
...
Your repo (`kv-hack2026-ctrl-shift-win`) must follow this layout. We expect your codebase organised this way —
