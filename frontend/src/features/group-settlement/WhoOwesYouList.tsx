...
export default function WhoOwesYouList({ items, totalOwedToYou, onToggleSettle }: Props) {
  return (
    <div className="bg-white rounded-3xl border border-emerald-100 shadow-sm p-5 md:p-6 space-y-3.5 mb-6">
